...
int create_room(struct session *ses, char *format, ...) {
    ...
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->vnum    = atoi(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->flags   = atoi(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->color   = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->name    = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->symbol  = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->desc    = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->area    = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->note    = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->terrain = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->data    = strdup(buf);
    arg = get_arg_in_braces(ses, arg, buf, FALSE);
    newroom->weight  = atof(buf);
